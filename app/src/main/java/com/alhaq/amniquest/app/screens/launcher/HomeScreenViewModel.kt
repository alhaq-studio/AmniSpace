...
import com.alhaq.amniquest.app.screens.game.showStreakUpDialog
...
import com.alhaq.amniquest.core.core.utils.getCurrentTime12Hr
import com.alhaq.amniquest.core.core.utils.getCurrentTime24Hr
    ...
    fun getFCMToken(onTokenReceived: (String?) -> Unit) {
        val pushProvider: PushProvider =
            if (!BuildConfig.IS_FDROID) {
                com.alhaq.amniquest.push.PlayPushProvider()
            } else {
                com.alhaq.amniquest.push.FdroidPushProvider()
            }
