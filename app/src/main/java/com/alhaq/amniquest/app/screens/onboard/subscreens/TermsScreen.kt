...
fun TermsScreen(isTosAccepted: MutableState<Boolean>) {
    ...
    Column(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(
                text = "Welcome to AmniQuest. A mindful focus launcher and gamified habit tracker built to help you reclaim your time and build purposeful daily habits.\n\n" +
                        "Ready to begin your journey toward intentional focus and digital peace?\n\n ~ Al-Haq Studio",
