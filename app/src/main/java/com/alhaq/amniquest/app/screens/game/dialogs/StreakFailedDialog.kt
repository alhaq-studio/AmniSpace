package com.alhaq.amniquest.app.screens.game.dialogs
...
import com.alhaq.amniquest.core.core.utils.managers.SoundManager
...
fun StreakFailedDialog(
    ...
    LaunchedEffect(streakDaysLost) {
        ...
        soundManager.playSound(com.alhaq.amniquest.R.raw.streap_fail)
