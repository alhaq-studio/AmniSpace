...
fun UsageAccessPerm() {
    ...
    Column(
        ...
        Text(
            text = "Please allow AmniQuest to access app usage data to show you detailed statistics about your screen time usage and help find ways to reduce it. All of this data is processed 100% locally and nothing is sent to our servers.",
            textAlign = TextAlign.Center,
