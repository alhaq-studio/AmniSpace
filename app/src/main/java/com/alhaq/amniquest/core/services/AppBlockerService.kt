package com.alhaq.amniquest.core.services
...
import com.alhaq.amniquest.core.R
import com.alhaq.amniquest.core.core.utils.managers.getKeyboards
            ...
            if (result.isSuccess) {
                ...
                allApps = allApps.filter {
                    !AppBlockerServiceInfo.deepFocus.exceptionApps.contains(it.packageName) && !keyboardApps.contains(
                        it.packageName
                    ) && it.packageName != "com.alhaq.amniquest"
                }
